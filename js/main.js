...
const printMovies = (movieData) => {
    ...
    movieData.forEach(element => {
        ...
        <a class="portfolio-item d-block mx-auto" id="miModal">
...
myModal.addEventListener('onclick', ()=>{
    movieData.forEach(element => {
    let printModal=`<div class="portfolio-modal mfp-hide" id="portfolio-modal-1">
    ...
    <div class="container text-center">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          <h2 class="text-secondary text-uppercase mb-0">${element.Title.toUpperCase()}</h2>
        <hr class="star-dark mb-5">
        <img class="img-fluid mb-5" src="${element.Poster}" alt="">
